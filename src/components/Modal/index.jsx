...
export default () => {
    const {setCats, curCatId, setCurCatId, modalState, setModalState, curName, setCurName, curAge, setCurAge, curRate, setCurRate, curImage, setCurImage, curDescription, setCurDescription, curFavorite, setCurFavorite} = useContext(Ctx);
        ...
        <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
                <div className="modal-header">
                    <h3 className="modal-title">Кот</h3>
                ...
                <div className="modal-body">
                    <form>
                        ...
                        <label htmlFor="favorite" className="form-label">Избранная</label>
                        <input className="form-radio" type="checkbox" name="favorite" value={curFavorite} onChange={e => setCurFavorite(e.target.checked)}/>
                    </form>
                </div>
